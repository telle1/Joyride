        ...
        <Row className="mt-4">
            <Col xs={5} className="pr-0">
                ...
                <a href="https://www.linkedin.com/in/tiffany-luu0/" target="_blank" className="d-block" 
                    data-aos="zoom-in" data-aos-delay="3000" data-aos-easing="ease-in-sine" data-aos-anchor="#anchor-0">
                    Here is my LinkedIn: tiffany-luu0
                </a>
            </Col>
            <Col className="pl-0 ml-n3">
                <h1 className="about-me-hi" id="anchor" 
                data-aos="fade-up" data-aos-delay="2250">
                    Nice to meet you, I'm Tiffany
                </h1>
                <p className="text-justify about-me-par" data-aos="fade-up" data-aos-delay="2150">
                ...
                <p className="about-me-par text-justify" data-aos="fade-up" data-aos-delay="2000">
                ...
                <p className="about-me-par text-justify" data-aos="fade-down" data-aos-delay="2000">
                ...
                <p className="about-me-par text-justify mb-0" data-aos="fade-down" data-aos-anchor="#anchor" data-aos-delay="2150">
                ...
                <h4 className="float-right about-me-hi" data-aos="fade-down" data-aos-anchor="#anchor" data-aos-delay="2250">
                    ♡ Tiffany Luu
                </h4>
            </Col>
        </Row>
        <Row className="about-me-header about-me-footer mx-0" data-aos-anchor="#anchor">
            <h1 data-aos="fade-up-left" data-aos-delay="2900" className="header-end">T</h1>
            <h1 data-aos="fade-up-left" data-aos-delay="2850" className="header-space">I</h1>
            <h1 data-aos="fade-up-left" data-aos-delay="2800">F</h1>
            <h1 data-aos="fade-up-left" data-aos-delay="2750">F</h1>
            <h1 data-aos="fade-up-left" data-aos-delay="2700">A</h1>
            <h1 data-aos="fade-up-left" data-aos-delay="2650">N</h1>
            <h1 data-aos="fade-up-right" data-aos-delay="2600">Y</h1>
            <h1 data-aos="fade-up-right" data-aos-delay="2550" className="header-space">-</h1>
            <h1 data-aos="fade-up-right" data-aos-delay="2500">L</h1>
            <h1 data-aos="fade-up-right" data-aos-delay="2450">U</h1>
            <h1 data-aos="fade-up-right" data-aos-delay="2400">U</h1>
            <h1 data-aos="fade-up-right" data-aos-delay="2350" className="header-end">0</h1>
